...
Set-Content -Path "$cesta_2$m3u_file_name" -Encoding String -Value $obsah_m3u # -Encode String gunguje ve Winampu !!

# Unknown, String, Unicode, Byte, BigEndianUnicode, UTF8, UTF7, UTF32, Ascii, Default, Oem, BigEndianUTF32"

# POZOR kodovani originalniho playlsitu vytvoreneho WinAmpem je CP 1250 !!!!
