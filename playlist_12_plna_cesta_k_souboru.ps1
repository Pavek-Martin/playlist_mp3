...
$pole_include = @("*.flac" ,"*.ogg" ,"*.mp3" ,"*.mod" ,"*.m4a", "*.wav")
...
if ( $files -ne 0 ){ # palize je neco mp3 v adresari, jinak nic nezapisuj
...
"@echo off"
"playlist.exe"
# stimto nazvem to bude zkompilovany a pak v davce zavola toto a vlastne se akualizuje
